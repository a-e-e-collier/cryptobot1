...
# from config import GAS_LIMIT, GAS_PRICE
...
global GAS_LIMIT, GAS_PRICE, NETWORK
GAS_LIMIT, GAS_PRICE, NETWORK = db.get_params('api')
...
class Uniswap:
    ...
    def _get_tx_params(self, value: Wei = Wei(0), gas: Wei = Wei(GAS_LIMIT), gasP: Wei = Wei(GAS_PRICE)) -> TxParams:
    ...
    #def _get_tx_params(self, value: Wei = Wei(0), gas: Wei = Wei(GAS_LIMIT)) -> TxParams:
        """Get generic transaction parameters."""
        #return {
            #"from": _addr_to_str(self.address),
            #"value": value,
